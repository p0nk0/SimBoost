        ...
        <div className="App">
            <header className="App-header">
                ...
                <Link to="/">
                    ...
                    <h5> By: Sonica Prakash and Taylor Roberts </h5>
                    ...
                    <p id = "paragraph"> We will use the average of 10000 Monte Carlo simulation to predict the daily stock prices over a timeframe that you specify Use the General Model Parameters to specify the start and ending dates over the entire time frame of stock data to be used in the model. Enter a prediction start date within the Start and End dates of the general model. Monte Carlo uses historical stock data from the General Start Date to Prediction Start Date to make daily stock predictions from the Prediction Start Date to General End Date. Predictions will also display on the graph along with a Mean Absolute Percentage Error!</p>
                    ...
                    <p id = "paragraph"> Use the General Model Parameters to specify the start and ending dates over the entire time frame of stock data to be used in the model. Input a Start Date for your contract. The model uses historical stock data from General Start Date to Contract Start Date to price an option that starts on the Contract Start Date and expires on the General End Date.  </p>
                    ...
                    <p id = "paragraph"> The Binomial Pricer model also predicts prices for Call Option and Put Option contracts of 100 shares per contract, assuming a European type option. Use the General Model Parameters to specify the start and ending dates over the entire time frame of stock data to be used in the model.  Input a Start Date for your contract. The model uses historical stock data from General Start Date to Contract Start Date to price an option that starts on the Contract Start Date and expires on the General End Date. Also include the number of time steps used for model prediction. </p>
                    <p id = "paragraph"> Like Black-Scholes, the model outputs the same results based on model parameters. </p>
